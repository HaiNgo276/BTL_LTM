...
//            ss = new ServerSocket(port, 0, InetAddress.getByName("10.20.137.129"));
            ...
            ThreadPoolExecutor executor = new ThreadPoolExecutor(
                    10,  // corePoolSize
                    200, // maximumPoolSize (tăng lên để xử lý nhiều client hơn)
                    30,  // thread timeout (tăng thời gian chờ)
                    TimeUnit.SECONDS,
                    new ArrayBlockingQueue<>(16) // queueCapacity (tăng dung lượng hàng đợi)
            );
